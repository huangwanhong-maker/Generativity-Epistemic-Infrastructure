...
**Package:** [Nine Working Drafts, version 0.2](../../publications/README.md)  
...
The full [build report](../../build/publications/build-report.json) records compiler outcomes, source/preamble/PDF hashes, warnings and tool versions. The [check report](../../build/publications/check-report.json) records structural checks, archive integrity, retained IDs, local reference resolution, freshness and PDF text coverage. These generated files are ignored and need regeneration after source changes.
